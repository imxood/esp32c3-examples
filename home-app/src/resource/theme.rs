use epi::egui::{style::Margin, vec2, Color32, Rounding, Style, Visuals};
...
pub struct Theme {
    ...
    /// 蓝色风格
    blue_style: Style,
    blue_titlebar_style: Style,
    blue_video_content_style: Style,
}
...
impl Theme {
    ...
    pub fn blue_titlebar_style_clone(&self) -> Style {
        self.blue_titlebar_style.clone()
    }

    pub fn blue_video_content_style(&self) -> Style {
